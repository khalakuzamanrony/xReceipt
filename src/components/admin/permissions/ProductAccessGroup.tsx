...
export default function ProductAccessGroup({
  ...
  const [assignMode, setAssignMode] = useState<boolean>((permissions.assigned_product_ids?.length || 0) > 0)
  ...
  return (
    <div className="border border-gray-200 rounded-lg p-5 space-y-4 bg-white">
      ...
      <div className="space-y-3">
          ...
          <div className="flex items-center gap-2">
            <Checkbox
              ...
              onCheckedChange={(checked) => {
                ...
                if (!value) {
                  onChange('assigned_product_ids', [])
                } else if (!permissions.can_view_products) {
                  onChange('can_view_products', true)
                }
              }}
            />
        ...
        {permissions.can_view_products && assignMode && (
